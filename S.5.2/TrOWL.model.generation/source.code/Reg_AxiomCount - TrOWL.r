...
plot(AxiomCount ~ msec, ylab="Axiom Count of Sample", xlab="Execution Time of a Sample (msec.)", 
       data = myData, main="10 Samples of SnomedCT on TrOWL")  ## use file names as title
...
fileConn<-file("prediction4thresholds/SnomedCT_Predictions_From_10_Samples_For_TrOWL.txt")
