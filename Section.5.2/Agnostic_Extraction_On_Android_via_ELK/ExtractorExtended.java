...
//		String dOntoFileName = "snomed_jan17.owl";
		...
		String dDesiredFileName = "Desired_test.txt";
	...
	public String extractKnowledge(String pOntologyFilePath,
		...
		try {
			...
			String dLogFileName = directoryLog + File.separator + dNow + "_" + dFileName + "_" + maxAxiomCount + ".log"; // moduleFilenameHeader
			...
			dExtactedFileName = dOutputFolder + File.separator + dNow + "_" + dFileName + "_" + maxAxiomCount + "." + dFileExtention; // moduleFilenameHeader+
