...
//		String dOntoFileName = "snomed_jan17.owl";
		String dOntoFileName = "emap.owl";
		
		String dDesiredFileName = "Desired_1sp_emap.txt";
		...
		try {
			...
			BufferedReader br = new BufferedReader(new FileReader(dOntoFolder + File.separator + "AxiomCounts_emap.txt"));
