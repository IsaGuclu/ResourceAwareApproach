...
public class ExtractorExtended {
	...
	public static void main(String[] args) {
		...
		String dOntoFileName = "chebi.owl";
//		String dOntoFileName = "00540.owl_functional.owl"; 
		
		String dDesiredFileName = "Desired_1sp_chebi.txt";
		...
		try {
			...
			BufferedReader br = new BufferedReader(new FileReader(dOntoFolder + File.separator + "AxiomCounts_chebi.txt"));
