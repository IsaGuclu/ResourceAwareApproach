...
//		String dOntoFileName = "snomed_jan17.owl";
		String dOntoFileName = "go.owl";
		
		String dDesiredFileName = "Desired_1sp_go.txt";
		...
		try {
			...
			BufferedReader br = new BufferedReader(new FileReader(dOntoFolder + File.separator + "AxiomCounts_go.txt"));
