...
public class ExtractorOptimized {
...
//		String dOntoFileName = "snomed_jan17.owl";
		String dOntoFileName = "fma-el.owl";
		
		String dDesiredFileName = "Desired_1sp_fma-el.txt";
		ExtractorOptimized dCls = new ExtractorOptimized();
		try {
			...
			BufferedReader br = new BufferedReader(new FileReader(dOntoFolder + File.separator + "AxiomCounts_fma-el.txt"));
	...
	public String extractKnowledge(String pOntologyFilePath,
		...
		try {
			...
			String dLogFileName = directoryLog + File.separator + logHeader + dNow + "_" + dFileName + "_" + maxAxiomCount + ".log";
			...
			// declaration axioms are not needed and therefore we skipp them
			
//			// this gets rid of the annotations 
